...
func TestAdminStreaksRestoreWithWireMock(
    t *testing.T,
) {
    ...
    _, invocationErr :=     client.Admin.Streaks.Restore(
            context.TODO(),
            request,
            option.WithHTTPHeader(
                http.Header{"X-Test-Id": []string{"TestAdminStreaksRestoreWithWireMock"}},
            ),
        )
