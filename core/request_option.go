...
func (r *RequestOptions) ToHeader() http.Header {
	...
	sdkVersion := fmt.Sprintf("%v", "1.19.0")
	if r.SdkVersion != "" {
		sdkVersion = fmt.Sprintf("%v", r.SdkVersion)
	}
	header.Set("X-SDK-VERSION", sdkVersion)
	if r.TenantId != nil {
...
// SdkVersionOption implements the RequestOption interface.
type SdkVersionOption struct {
	SdkVersion string
}

func (s *SdkVersionOption) applyRequestOptions(opts *RequestOptions) {
	opts.SdkVersion = s.SdkVersion
}
