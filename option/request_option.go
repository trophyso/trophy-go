...
func WithEnvironment(environment trophygo.Environment) *core.EnvironmentOption {
...
// WithSdkVersion sets the sdkVersion request header.
func WithSdkVersion(sdkVersion string) *core.SdkVersionOption {
	return &core.SdkVersionOption{
