...
func TestStreaksListWithWireMock(
    t *testing.T,
) {
    ...
    _, invocationErr :=     client.Streaks.List(
            context.TODO(),
            request,
            option.WithHTTPHeader(
                http.Header{"X-Test-Id": []string{"TestStreaksListWithWireMock"}},
            ),
        )

    require.NoError(t, invocationErr, "Client method call should succeed")
    VerifyRequestCount(t, "TestStreaksListWithWireMock", "GET", "/streaks", map[string]interface{}{"userIds": "userIds"}, 1)
}
